...
let baseQuery = ` i.id, i.headline, i.media_section, i.spokesperson, i.comments, i.language, i.date, i.uploaded, i.has_video, 
                i.statements, i.proactivity, i.type as impact_type, i.photo_count, i.url, i.shortened_url,m.content, m.coverage, m.name, m.id as media_id, 
                m_t.type, m_t.id as media_type_id, d.summary as summary, d.pr_news
...
exports.getImpactsByUser = user_id => db.any('SELECT $1:raw AND added_by = $2',[baseQuery,user_id])
//Update
exports.updateImpact = (impact,id) =>db.none(pgi.helpers.update(impact, null, 'impact') + 'WHERE id = '+id)
//Delete
