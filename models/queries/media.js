...
exports.getAll = () => db.multi(`SELECT media.id, media.name, media.url,media.coverage,media.format,media_type.type,media.content FROM media,media_type WHERE media.type = media_type.id;
