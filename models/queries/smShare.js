...
//Update
exports.updateShare = (share, id) =>
  db.none(pgp.helpers.update(share, null, "sm_share") + "WHERE id = " + id);

//Delete
exports.deleteShare = impact_id =>
  db.none("DELETE FROM sm_share WHERE id=($1)", [impact_id]);
