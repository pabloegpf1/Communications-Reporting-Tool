  ...
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert("dissemination", [
      ...
      },
      {
        added_by: 1,
        headline:
          "Investigadores de la UC3M e IMDEA Networks presentan sus novedades sobre 5G en el Mobile World Congress 2018",
      ...
      },
      {
        added_by: 1,
        headline:
          "IMDEA Networks participa en el primer máster sobre 5G del mundo",
        summary: `First 5G master's degree`,
        date: "2018-03-13 00:00:00.000+00",
        pr_news: "NEWS",
        url:
          "https://www.networks.imdea.org/es/actualidad/noticias/2018/imdea-networks-participa-primer-master-sobre-5g-mundo"
      },
      {
        added_by: 1,
        headline:
      ...
      },
      {
        ...
        pr_news: "NEWS",
        url:
          "https://www.networks.imdea.org/es/actualidad/noticias/2018/procesamiento-dinamico-redes-5g"
      },
      {
        added_by: 1,
        headline:
      ...
      },
      {
        ...
        pr_news: "NEWS",
        url:
          "https://www.networks.imdea.org/es/actualidad/noticias/2018/desarrollan-una-herramienta-que-muestra-brecha-genero-facebook"
      },
      {
        added_by: 1,
        headline:
        ...
        pr_news: "NEWS",
        url:
          "https://www.networks.imdea.org/es/actualidad/noticias/2018/un-sistema-posicionamiento-impulsa-futura-innovacion-inalambrica"
      }
    ]);
  },
